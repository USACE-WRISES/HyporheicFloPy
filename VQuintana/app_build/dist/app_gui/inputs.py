...
class Settings(BaseModel):
    ...
    md6_exe_path : Path = pu.resource("modflowExe", "mf6.exe")
    md7_exe_path : Path = pu.resource("modflowExe", "mp7.exe")
    ...
    def setup_workspace(self, clean: bool = True) -> None:
        ...
        #print(f"Workspace absolute path: {self.workspace_path}")
...
def load(source: Union[str, Path, IO[str]] | None = None,
    ...
    if source is None:
        ...
        path = _find_inputs_yaml(Path(ROOT))#Path.cwd())
    else:
